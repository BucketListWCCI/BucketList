namespace BucketList.Migrations
{
    ...
    public partial class testafterdeleteingmigrations : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Shopping_ShoppingId = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Shoppings", t => t.Shopping_ShoppingId)
                .Index(t => t.UserName, unique: true, name: "UserNameIndex")
                .Index(t => t.Shopping_ShoppingId);
